...
variable "project_name" { type = string; default = "content-engine" }
variable "environment"  { type = string; default = "prod" }
variable "domain_name"  { type = string }
variable "subdomain"    { type = string; default = "studio" }
...
variable "stripe_price_id"       { type = string; sensitive = true }
