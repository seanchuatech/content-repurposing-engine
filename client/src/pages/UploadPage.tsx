...
import { importFromYouTube, uploadVideo } from '../lib/api';
...
export default function UploadPage() {
  ...
  const validateFile = useCallback((file: File) => {
    ...
    if (!isValidMime && !isValidExtension) {
      setErrorMessage(
        'Invalid file type. Only MP4, MOV, and WebM are supported.',
      );
      return false;
    }
      ...
      const options = {
        ...
        manualSegments:
          manualSegments.length > 0
            ? manualSegments.map(
                (s: { start: string; end: string; title: string }) => ({
    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-zinc-400">
          Upload a file or paste a YouTube link to start detecting viral
          moments.
        </p>
      </div>
          ...
          <div className="w-full max-w-md space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-500 text-center">
                We'll download and process it automatically
              </p>
            </div>
            <input
              type="text"
            ...
            <div className="flex items-center gap-4 p-4 bg-zinc-800/50 rounded-lg border border-zinc-700 mb-8 relative">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-white truncate">
                  {uploadType === 'file' ? file?.name : ytUrl}
                </p>
                  ...
                  <div className="space-y-6 text-left animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-[11px] text-zinc-500 italic">
                        Select smaller models to save compute time.
                      </p>
                    </div>
                    ...
                    {uploadType === 'youtube' && (
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          onChange={(e) =>
                            setUseYouTubeSubtitles(e.target.checked)
                          }
                    ...
                    <div className="space-y-3">
                      ...
                      {manualSegments.length > 0 ? (
                        ...
                        <p className="text-[11px] text-zinc-500">
                          If provided, AI analysis will be skipped.
                        </p>
                      )}
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-center text-indigo-400 font-medium animate-pulse">
                  {uploadType === 'file'
                    ...
                    : 'Initiating download and analysis...'}
                </p>
              </div>
            )}
        ...
        {[
          {
            ...
            desc: 'AI identifies the best moments for you.',
          },
          {
            title: 'Subtitles',
            desc: 'Word-level captions burned in automatically.',
          },
          {
            title: 'Smart Crop',
