    ...
    <div className="min-h-full bg-slate-950 px-6 py-12 lg:px-8">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-6 text-lg leading-8 text-slate-300">
          Transform your long-form content into viral shorts with AI-powered
          transcription, analysis, and framing.
        </p>
      </div>
      ...
      <div className="mx-auto mt-16 max-w-lg rounded-3xl bg-slate-900 ring-1 ring-slate-800 p-8 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
        <div className="p-8 sm:p-10 lg:flex-auto">
          ...
          <p className="mt-6 text-base leading-7 text-slate-300">
            Perfect for content creators looking to maximize their reach across
      ...
      <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
        <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
          ...
          <div className="flex flex-col">
            ...
            <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-slate-400">
              <p className="flex-auto">
                Our distributed worker nodes handle video processing in minutes,
                not hours.
              </p>
            </dd>
          </div>
          <div className="flex flex-col">
            ...
            <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-slate-400">
              <p className="flex-auto">
                Access advanced AI models for better viral scores and highly
